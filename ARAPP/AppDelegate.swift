...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let middleVC = storyboard.instantiateViewController(withIdentifier: "middleVC")
        let rightVC = storyboard.instantiateViewController(withIdentifier: "rightVC")
        
        let appContainer = AppContainer.containerViewWidth(leftVC, middleVC: middleVC, rightVC: rightVC)
        
        self.window?.rootViewController = appContainer
